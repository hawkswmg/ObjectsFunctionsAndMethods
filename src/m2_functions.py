...
def turtle4():
    wow = rg.SimpleTurtle()
    wow.pen = rg.Pen('OrangeRed',10)
    wow.backward(100)
    wow.draw_regular_polygon(7,125)


def turtle5():
    fred = rg.SimpleTurtle()
    fred.pen = rg.Pen('gold',20)
    daphne = rg.SimpleTurtle()
    daphne.pen = rg.Pen('chocolate',6)

    fred.draw_circle(100)
    fred.right(60)
    fred.forward(90)
    daphne.left(90)
    daphne.draw_square(50)
