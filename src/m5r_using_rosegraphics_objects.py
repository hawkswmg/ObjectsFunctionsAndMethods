...
#                fill_color, attach_to, move_center_to
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                location of center is (300,100), radius is 50, fill color is green
#
#     f. What does a RoseWindow RENDER method do?
#           Draws all objects attached to the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#           It is necessary if the user wants to view the RoseWindow after the code has been run. This is important to catch whether the coding is correct or not
#
