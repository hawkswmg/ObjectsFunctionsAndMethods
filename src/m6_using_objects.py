...
def circle_and_rectangle():
    ...
    circle = rg.Circle(rg.Point(200,150), 50)
    circle.fill_color = 'blue'
    circle.attach_to(window)

    rectangle = rg.Rectangle(rg.Point(40,50),rg.Point(120,200))
...
def lines():
    ...
    line2 = rg.Line(rg.Point(50,100),rg.Point(250,110))
    line2.thickness = 5
